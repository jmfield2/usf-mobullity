...
/* Define layers icons */
bluephone_icon =  L.icon({angle:0, iconUrl: '/images/marker-bluephone.svg', iconSize: new L.Point(30,60)});
carshare_icon = L.icon({angle:0, iconUrl: '/images/marker-carshare.svg', iconSize: new L.Point(30,60)});

L.layersIcon = L.Icon.extend({
    options: {
        iconSize: [35, 45],
        icon: '',
        color: 'blue',
    ...
    createIcon: function() {
        ...
        div.className = "layersIcon-" + this.options.color;
        return div;
    },

});
bikerepair_icon = new L.layersIcon({icon: 'mdi mdi-wrench'});
carcharging_icon = new L.layersIcon({icon: 'mdi mdi-battery-charging'});
parkinglot_icon = new L.layersIcon({icon: 'mdi mdi-parking'});
...
//        }
  ...
  //               }
    ...
    layersWidget: [
        ...
        { name: 'car_share', target: '#carshare', icon: carshare_icon, type: 'static', title: 'Enterprise CarShare', popup: "<a target='_blank' href='https://www.enterprisecarshare.com/us/en/programs/university/usf.html'>Reserve a car</a>", locations: [[28.059951, -82.417575], [28.064287, -82.412130]] },

        { name: 'bike_repair', target: '#bikerepair', icon: bikerepair_icon, type: 'poi', search: 'bicycle_repair_station', popupTemplate: 'bikeRepair-template' },
        { name: 'car_charging', target: '#carcharging', icon: carcharging_icon, type: 'poi', search: 'charging_station', popupTemplate: 'carCharging-template' },
        { name: 'parking', target: '#parkinglots', icon: parkinglot_icon, type: 'poi', search: 'amenity:parking', popupTemplate: 'parkingLots-template', condition: "permits" },
    ],
